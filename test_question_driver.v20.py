...
ResponseHeader: '{response_header}"""
		...
		# 2022-05-31T14:57:27PDT more printing changes, hopw they are okay (END OF SECTION)
				...
				# NOTE: The finding_to_add in the
				# immediately next line will v likely
				# implicated in failure bc it has not
				# been subject to the needed changes
				# regarding
				# Refactor2022-07-02T08:53:21PDT.  Why
				# not?  Bc this whole block will not
				# be called due to the if false at
				# 2022-07-01T11:45:28PDT
...
"""
		...
		#!
			...
			if nth_question == 31:
				print("Okay it's 2022-07-02T15:31:11PDT and we are trying to debug the difference between")
				print("RegressionTestLogs2/Consult.2022-06-30T1026-Cpd-73/Q031-usr-reply-Id005.json and")
				print("RegressionTestLogs3/Consult.2022-07-02T1445-Cpd-73/Q031-usr-reply-Id005.json")
				pdb.set_trace()
...
def ppj(json, sort_keys = True, indent = 2):
	"""pretty print json object"""
	print(json.dumps(response_content_list, sort_keys = sort_keys, indent = indent))
