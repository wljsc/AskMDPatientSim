...
PRINT_MASSIVE_SPEW_OF_POST_P = True 
...
def test_guidance_options_full_scale(dir_of_dir_of_dirs, verbose_p = True, reverse_order_p = False):
	...
	for run_group_dir in list_of_run_group_dirs:
	    test_guidance_options_from_many_dirs(run_group_dir, base_dir = dir_of_dir_of_dirs, reverse_order_p = reverse_order_p)
...
def test_guidance_options_from_many_dirs(dir_of_dirs, base_dir = None, verbose_p = True, reverse_order_p = False):
...
def test_guidance_options_from_dir(consult_subdir_name, dir_of_dirs = None, verbose_p = True, log_file_p = True):
...
# I might retired this function test_guidance_options_from_dict(
...
def test_guidance_options_from_dict(
	...
	if verbose_p:
		...
		if PRINT_MASSIVE_SPEW_OF_POST_P:
			...
			#print("PRINT_MASSIVE_SPEW_P is false so we aren't going to print payload_as_json_dict")
			print("PRINT_MASSIVE_SPEW_OF_POST_P is false so we aren't going to print payload_as_json_dict")			
		print()	
	...
	if error_msg_exception_during_post:
		...
		print(f"finding list file is: {finding_list_input_filepath}
