...
# 2022-07-02T08:57:30PDT test_question_driver.v19.py
...
def process_system_reply(
	...
	#findings_to_add = []
	#2022-07-02T08:53:21PDT changed the above to this
	...
	for resp_section_num, response_section in enumerate(response_sections):
		...
		print(f"Also, findings_to_add is {findings_to_add}")
		print()
		pdb.set_trace()

		#!print("2022-07-01T17:16:05PDT tracing here to see why assumption violation of findings_to_add must be [] (i.e. 2022-06-22T11:35:40PDT)")
		...
		#! At 2022-07-01T11:45:28PDT (see this timestamp
		#! elsewhere) we are attempting to resolve
		#! 2022-06-22T11:28:04PDT.
		#!
		#! To do so, I've commented out this...
		#!
...
"""
		...
		#!
			...
			if findings_to_add != []:
				print("Here in 'Big Branch 5: Mixed - Multiple Choice and Give a type-in value for each response ele'...")
				...
				print("A clear case, realized at 2022-07-01T17:43:10PDT, in which this is violated is we have in 62, first we answer gender.  We have that as a fnd_to_ad and then we get the DOB")
			...
			print("the return value to that fn, gets assigned to @param finding_to_add_from_this,")
			print()
			print("Issues around assumption violation of findings_to_add must be [] (i.e. 2022-06-22T11:35:40PDT)")
...
def handle_mixed_response_content_list(
	...
	if findings_to_add != []:
		print("Here in @func handle_mixed_response_content_list, We expected findings_to_add to be []. ")
		print("This violates assumption at 2022-06-22T11:35:40PDT.")
		print("Thus we may need to make different place about removing findings_to_add")
