	...
	for combo_of_fnd_ids in all_combos_of_contributing_finding_ids:
		...
		if if_post_exception_log_retry_and_continue_p:
			...
			try:
				...
				end_time_in_secs = round(time.time(), 2)
				duration_in_secs = round(end_time_in_secs - start_time_in_secs, 2)
				print(f"#### Duration of ProxyFindingCombination {duration_in_secs} (secs): {consult_id}: ProgRecNum: {program_rec_num} FndCombo: {combo_of_fnd_ids}: {duration_in_secs} (First Post Try Failed)")
				print("################################################################")
...
| 4GREP | TypeError: Cannot read property 'getEntityId' of null |  CPD | 188 | PRN |  46 | "urine is dark, red, or has visible blood" | "Urinary Problems in Men Diagnosis" | CFS | 16 | 18  |
				...
				try:
					...
					print(f"#### Duration of ProxyFindingCombination {duration_in_secs} (secs): {consult_id}: ProgRecNum: {program_rec_num} FndCombo: {combo_of_fnd_ids}: {duration_in_secs} (Second Post Try Failed)")
					print("################################################################")
					...
					duration_in_secs = round(end_time_in_secs - start_time_in_secs, 2)
					print(f"#### Duration of ProxyFindingCombination {duration_in_secs} (secs): {consult_id}: ProgRecNum: {program_rec_num} FndCombo: {combo_of_fnd_ids}: {duration_in_secs} (Second Post Successful)")

			else:
				duration_in_secs = round(end_time_in_secs - start_time_in_secs, 2)
				print(f"#### Duration of ProxyFindingCombination {duration_in_secs} (secs): {consult_id}: ProgRecNum: {program_rec_num} FndCombo: {combo_of_fnd_ids}: {duration_in_secs} (First Post Successful)")
