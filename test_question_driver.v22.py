...
def user_input_wrapper(prompt_text, 
	...
	@param number_of_choices - this is only needed for certain
	types of AutoMode.  

		IF the 'policyInAutoMode' is RandomAnswerForMultiChoice-UnlessBotError
		...
		that is >= 0 and < number_of_choices
	...
	if number_of_choices is None:
		print("Tracing at 2022-07-07T09:42:45PDT to debug the 'TypeError: unsupported operand type(s) for -: 'NoneType' and 'int'' for Cpd 47 BotSubQuestion# 4 of 4:")
		pdb.set_trace()
		...
		if response_policy:
			if response_policy == "AlwaysAnswerZero":
				...
				if asking_how_to_handle_bot_error_p:
					...
					user_reply_txt = random.randint(0,number_of_choices - 1)
