...
def post_users_reply(payload, log_dir, question_seq_index, conversation_log_filepath, log_of_post_durations_fileobj):
	...
	print("Just Before Post: For sleep 2 seconds - hoping to easily prevent 'Max retries exceeded with url' error")
	time.sleep(2)
	...
	print("Just After Post: For sleep 2 seconds - hoping to easily prevent 'Max retries exceeded with url' error")	
	time.sleep(2)
