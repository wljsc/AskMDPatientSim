...
def test_finding_proxy(fnd_proxy_json, consult_json, grouping_type, error_log_filepath, validation_mode = True):
	"""
	...
	for combo_of_fnd_ids in all_combos_of_contributing_finding_ids:
		...
		if error_msg:
			...
			if fnds_added != []:
				print("Weird fnds_added is nonemptyr!")
				pdb.set_trace()
			if fnds_removed != []:
				print("Weird fnds_removed is nonemptyr!")
				pdb.set_trace()
