...
# 2022-06-03T11:18:38PDT test_question_driver.v11.yp
...
def question_and_answer_loop(start_conversation_with, log_basedir = None, auto_mode_user_reply_script_file = None, record_user_replies_for_reply_filename = None):
...
#question_and_answer_loop(14, log_basedir = "../TstCoupProgLogs/", auto_mode_user_reply_script_file = None, record_user_replies_for_reply_filename = "test_record_14.01.json")

#question_and_answer_loop(14, log_basedir = "../TstCoupProgLogs/", auto_mode_user_reply_script_file = "test_record_14.01.json", record_user_replies_for_reply_filename = None)
#question_and_answer_loop(62, log_basedir = "../TstCoupProgLogs/", auto_mode_user_reply_script_file = "test_record_14.01.json", record_user_replies_for_reply_filename = None)

#question_and_answer_loop(3, log_basedir = "../TstCoupProgLogs/", auto_mode_user_reply_script_file = "test_record_14.01.json", record_user_replies_for_reply_filename = None)
#question_and_answer_loop(4, log_basedir = "../TstCoupProgLogs/", auto_mode_user_reply_script_file = "test_record_14.01.json", record_user_replies_for_reply_filename = None)
#question_and_answer_loop(6, log_basedir = "../TstCoupProgLogs/", auto_mode_user_reply_script_file = "test_record_14.01.json", record_user_replies_for_reply_filename = None)
#question_and_answer_loop(7, log_basedir = "../TstCoupProgLogs/", auto_mode_user_reply_script_file = "test_record_14.01.json", record_user_replies_for_reply_filename = None)
...
#	question_and_answer_loop(db, log_basedir = "../TstCoupProgLogs/", auto_mode_user_reply_script_file = "test_record_14.01.json", record_user_replies_for_reply_filename = None)
	#sleep(1.3)
#	sleep(2)

# Cpd-0016.json

def make_list_of_cpd_db_nums(mydir, log_basedir = "../TstCoupProgLogs/"):
	...
	for cpd_filename in cpd_filename_list:
		...
		try:
			question_and_answer_loop(just_the_db_number, log_basedir = log_basedir, auto_mode_user_reply_script_file = "test_record_14.01.json", record_user_replies_for_reply_filename = None)
...
#make_list_of_cpd_db_nums(DIR_OF_CPD_FILES)
make_list_of_cpd_db_nums(DIR_OF_CPD_FILES, log_baseddir = "../TstCoupProgLogs/CONSYS-299"