...
# JIRAS:
# 117 https://arnoldmedia.jira.com/browse/CONSYS-329 CPD # 117 Cannot read property 'length' of undefined (created 2022-07-02T20:26:56PDT) 
# 140 https://arnoldmedia.jira.com/browse/CONSYS-330 CPD # 140 Cannot read property 'length' of undefined (created 2022-07-02T20:26:56PDT) 

# 147 https://arnoldmedia.jira.com/browse/CONSYS-331 CPD # 147: can't determine that question is a type in (created 2022-07-02T22:32:05PDT) 
...
# WAITING https://arnoldmedia.jira.com/browse/CONSYS-332 "Cpd 43,76,82,87,148 TypeError: Cannot read property 'length' of undefined" (created 2022-07-03)
...
# TypeError: Cannot read property 'length' of undefined
# SCRIPT: sex_dob_height_weight_then_all_zero_unless_error.json
# WAITING: https://arnoldmedia.jira.com/browse/CONSYS-330 CPD # 140 Cannot read property 'length' of undefined
...
# TODO maybe this will behave better if I do not answer just zero? figure out what are nominal levels and enter them (and it is 4 type ins).

# 43, PROBLEM "FullTopic": "COPD Management",
# BotAsks QuesSeq# 3 QuesId# 12 Title: 'COPD symptom severity' CPD: 43
# User chose: 0 few, mild day-to-day symptoms
# ResponseHeader: 'Which of these describes your COPD symptoms?'
# TypeError: Cannot read property 'length' of undefined
# SCRIPT: sex_dob_height_weight_then_all_zero_unless_error.json
# WAITING https://arnoldmedia.jira.com/browse/CONSYS-332 "Cpd 43,76,82,87,148 TypeError: Cannot read property 'length' of undefined"
...
# 322, PROBLEM
# ditto (i.e. see https://arnoldmedia.jira.com/browse/CONSYS-322 )
