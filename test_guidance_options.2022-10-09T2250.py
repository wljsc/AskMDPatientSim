...
# or consult_results_subdir_name or FINALLY consult_subdir_name
#def test_guidance_options_from_dir(sub_dir_name, log_basedir = None, verbose_p = True):
	...
	# TODO rename finding_list_input_dir to consult_subdir_name and remeved these commented lines
	...
	# TODO rename sub_dir_for_guidance_options_fullpath to guidance_options_results_full_dirpath
