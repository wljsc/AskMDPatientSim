...
def process_system_reply(
	...
	for resp_section_num, response_section in enumerate(response_sections):
		...
		# 	print("and response_content_list is:", ppj(response_content_list))
		...
		# TODO(2022-07-02T19:01:55PDT, ) once we are really
		# sure that 2022-06-22T11:28:04PDT is completed and
		# the needed testing DONE then blow away this if False
		# block.  MAYBE before blowing away it is improtant to
		# closely analyze and make sure that this does not do
		# any important that Big Branch 5 does not also do.
